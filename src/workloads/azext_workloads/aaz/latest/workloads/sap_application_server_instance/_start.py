...
class Start(AAZCommand):
    ...
    :example: Start an Application server instance of the SAP system
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SapApplicationServerInstancesStart(ctx=self.ctx)()
    ...
    class SapApplicationServerInstancesStart(AAZHttpOperation):
