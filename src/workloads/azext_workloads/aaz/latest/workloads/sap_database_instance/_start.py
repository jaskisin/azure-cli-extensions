...
@register_command(
    "workloads sap-database-instance start",
    is_preview=True,
)
class Start(AAZCommand):
    ...
    :example: Start Database instance of the SAP system and its underlying Virtual Machine. Currently start action is supported for SAP HANA Database only
    ...
    def _execute_operations(self):
        self.pre_operations()
        yield self.SapDatabaseInstancesStart(ctx=self.ctx)()
    ...
    class SapDatabaseInstancesStart(AAZHttpOperation):
